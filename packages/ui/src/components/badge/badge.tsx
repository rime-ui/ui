...
const badge = tv({
    ...
    variants: {
        variant: {
            ...
            secondary:
                'bg-secondary text-gray-800 before:shadow-secondary  focus-visible:outline-none',
            ghost: 'bg-ghost text-sky-400 before:shadow-ghost focus-visible:outline-none border-[2px] border-ghost-dark',
            dangerous:
                'bg-dangerous text-white before:shadow-dangerous focus-visible:outline-none',
