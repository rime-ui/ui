...
const button = tv({
  ...
  variants: {
    variant: {
      ...
      ghost:
        'bg-ghost text-sky-400 before:rounded-[12px] before:shadow-ghost hover:brightness-[0.9] focus-visible:outline-none border-[2px] border-ghost-dark',
      dangerous:
  ...
  compoundVariants: [
    {
      ...
      outline: true,
      class:
        'bg-white text-primary-dark before:rounded-[12px] before:shadow-primary hover:brightness-[1.1] border-[2px] border-primary-dark',
    },
    {
      variant: 'secondary',
      outline: true,
      class:
        'bg-white text-secondary-dark before:rounded-[12px] before:shadow-secondary hover:brightness-[0.9] border-[2px] border-secondary-dark',
    },
    {
      variant: 'dangerous',
      outline: true,
      class:
        'bg-white text-red-600 before:rounded-[12px] before:shadow-dangerous border-[2px] hover:brightness-[0.9] border-[2px] border-dangerous-dark',
    },
  ],
  defaultVariants: {
    variant: 'primary',
