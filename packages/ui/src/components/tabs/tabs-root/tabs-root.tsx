...
type TabsRootProps = React.HTMLAttributes<HTMLDivElement> & VariantProps<typeof root> & { defaultValue: string, dir?: "rtl" | "ltr" };
...
export function TabsRoot(props: TabsRootProps) {
    ...
    return (
        <TabsProvider value={contextValue}>
            <div dir={props.dir} className={root({ className: props.className })}>{props.children}</div>
        </TabsProvider>
    );
}
